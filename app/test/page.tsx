  ...
  return (
    ...
    <section>
      <div className="hero bg-[#115d98] relative">
        ...
        after:content-[''] after:absolute after:w-[3000px] after:h-[85px] after:bottom-0 after:rounded-[50%]
        after:-translate-x-1/2 after:bg-[#000000] after:left-1/2 after:top-[0px]"></span>
      </div>
    </section>
    </main>
  )
