...
export default async function Post({params}: {params: {slug: string}}) {
  ...
  const mission = await getOurMission();
    ...
    <main>
      <section>
        <div className="content-container">
          <header>
            <h1 className="text-orange-600 text-center">Our Mission</h1>
          </header>
          <h2 className="text-black text-center"> {mission.ourMission.missionContent.missionTitle} </h2>
          <div className="flex">
            <Image
              alt=""
              src={mission.ourMission.missionContent.missionImage.node.sourceUrl}
              height = {500}
              width = {300}
              className="flex"
            />
            {mission.ourMission.missionContent.missionDescription}
          </div>
